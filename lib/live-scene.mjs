...
const scenes = {
  ...
  motion: { file: "bimp-mode.xyz", format: "xyz", label: "BIMP · vibrational mode", frames: 20 },
...
export async function liveSceneHtml(scene, theme) {
  ...
  const scripts = grid
    ...
    : ["molstar.js", "burette-agent.js", "trajectory-smoothing.js", "molstar-preset-preview-controller.js", "superposition-panel.js", "molecule-preview-interactions.js", "color-picker.js", "sequence-panel.js", "scene-file-actions.js", "viewer.js"];
  return `<!doctype html>
