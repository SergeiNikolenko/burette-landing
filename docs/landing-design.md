...
The presentation keeps the viewer’s existing appearance instead of selecting Illustrative at the start of every story. Only the SDF workflow changes appearance to Default for the requested transparent All overlay; deliberate representation changes still pass through the real menu.
