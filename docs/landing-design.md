...
The presentation initializes the workspace in Illustrative and keeps it for every molecular scene, including SDF All. It does not reselect appearance at the start of each story. Deliberate representation changes still pass through the real menu. In All, the pointer enables Align, leaves the aligned poses visible, then disables it to show their original coordinates.
