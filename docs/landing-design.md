...
The presentation cursor uses a compact dark arrow with a white outline and a soft shadow. It travels for 620 ms with a brief settle; only clicks produce a short expanding ring and press response. There is no persistent halo. The visible tip is aligned with the target, including nested frame scaling.
